...
\item \textbf{A reusable net--trace scorer.} One neural network for graphs and sequences predicts transition aware move preferences for variable size inputs and previously unseen label vocabularies, without training a neural network per target net (Section~\ref{sec:scorer}).
