...
\dataavailability{The implementation, synthetic data, pretrained checkpoint, and experiment scripts are available in the LARA repository at \url{https://github.com/fit-alessandro-berti/lara-align}. The journal source includes the numerical inputs used to draw its result figures. The public event-log sources are cited in Section~\ref{sec:real}.}
% Funding, CRediT roles, conflicts, and author-approved AI disclosure:
% see README.md. These author declarations are not inferred from the software.
