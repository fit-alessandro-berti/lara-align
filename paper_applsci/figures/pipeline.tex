...
\node[box,text width=32mm] (input) at (1.8,0) {Petri net $SN$\\complete trace $\sigma$};
\node[learnbox,text width=32mm] (encoder) at (6,0) {encode Petri net\\and trace\\exchange context};
